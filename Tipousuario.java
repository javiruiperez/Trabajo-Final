...
public class Tipousuario {
    public static void main(String[] args) {
        ...
        if (usrch == 2) {
            System.out.println("Has creado una cuenta de creador particular, disfruta creando encuestas y publicándolas o compartiéndolas con tus amigos o familiares.");
            creador.main();
        }else{
