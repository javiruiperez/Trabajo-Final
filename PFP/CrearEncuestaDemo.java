...
public class CrearEncuestaDemo {
    public static void main() {
        ...
        if(creachs == 1) {
            ...
            System.out.println("En una encuesta normal, será usted quien escogerá el número de preguntas, pero para esta vez estableceremos unas 5 preguntas para comenzar");
